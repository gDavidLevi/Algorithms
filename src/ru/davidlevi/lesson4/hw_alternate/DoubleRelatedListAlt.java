...
/**
 * DoubleRelatedListAlt - двусвязный список, где каждый элемент содержит ссылки на предыдущий и следующий элементы.
 * Версия класса от преподавателя.
 */
public class DoubleRelatedListAlt<T> implements MyIteratorAlt<T> {
    /**
     * Узел
     *
     * @param <T>
